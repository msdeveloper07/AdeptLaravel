    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li  class="active"><a href="/goodsin/createLot/{{$goodsin_id}}">Manage Lots</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  id="goodsin_id" name="goodsin_id" class="form-control" value="{{$goodsin_id}}" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  id="goods_in_date" name="goods_in_date" class="form-control" value="{{\App\Libraries\ZnUtilities::format_date($goodsin->goods_in_date,10)}}" >
