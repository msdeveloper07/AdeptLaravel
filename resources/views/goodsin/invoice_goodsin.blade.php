...
<!--            <tr><td colspan='5' style="border-top: 2px solid #000;">&nbsp;</td></tr>-->
            ...
            <tr rowspan="6">
                ...
                <?php $supplier_name = App\Models\Supplier::where('id',$goodsin->supplier_id)->pluck('supplier_name'); ?>
                ...
                <td colspan="2" style="text-align:right; "><b><u>SUPPLIER NAME:</u></b><br/>{{$supplier_name}}<br/><strong><u>HAULAGE COMPANY:</u></strong><br/>{{$goodsin->haulage_company_name}}<br/><br/><u><b>GOODS IN DATE:</b></u>&nbsp;&nbsp;<b>{{\App\Libraries\ZnUtilities::format_date($goodsin->goods_in_date,10)}}</b></td>
             </tr>
           ...
           <tr> <td colspan="4">&nbsp;</td></tr>
              ...
              <table width='100%' cellspacing="0.00001%" cellpadding="5%">
                 <tr>
                <td colspan="1" style=" float:left; width:25%; text-align: left; "><strong>JOB NUMBER:</strong>{{$goodsin->id}}</td>
                <td colspan="1" style=" float:center; width:40%;  text-align: center; "><b>PROJECT NAME:</b>{{$goodsin->project_name}}</div></td>
                <td colspan="2" style=" float:right;  width:35%; text-align: right; " ><b>ORDER NUMBER:</b>{{$goodsin->client_order_number}}</td>
               </tr>
             </table>
       <table width='100%' cellspacing="0.00001%" cellpadding="5%">
            ...
            <?php $total=array(); if($goodsin->goodsin_type==='Weekly/Dimension'){?>
           @foreach($lots as $k=>$l)
           <tr>    
           ...
           <tr>    
            ...
            @endforeach
            <?php
                  $total[]= $goodsin->total_volume; 
                 
            }
             $count = count($lots);?>
            @if($count==0)<tr><td colspan='4' style="border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000;" ><h4>Lots are not available for these Goods</h4></td></tr>
          @else
           <tr>
          ...
          @endif
         <tr>
             <td colspan="2"  style="text-align: left; border-left: 1px solid #000; "><strong>HANDLING CHARGE:</strong>&#163;{{$goodsin->handling_charge}}</td>
         ...
         <tr>
             ...
             <td colspan="2" style="text-align: right; border-right: 1px solid #000;"><strong>STORAGE CHARGE(@if($goodsin->goodsin_type==='Weekly/Dimension')Per Week @else Per day @endif):</strong>&#163;{{number_format(array_sum($total)*$goodsin->charge_rate, 2, '.', '')}}</td>
            </tr>
              <tr>
