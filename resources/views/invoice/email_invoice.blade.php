...
<div class="row">
    ...
    <div class="col-md-6">
        <form  role="form" action='/emailInvoiceStore' name='email__form' id='email_form' method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Email" id="email" name="email" class="form-control" value="{{$clients->email}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Subject for the Email" id="subject" name="subject" class="form-control " value="{!! \App\Models\Setting::where('setting_name','monthly_invoice_subject')->first()->setting_value !!}">
                            </div>
                        </div>
                    </div>
