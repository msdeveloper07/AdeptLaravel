    ...
    <div class="box box-danger">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <select id="archive" name="Status" class="form-control" onchange="javascript:location.href = this.value;" placeholder="Select Action"  >
                            <option {{$status=='goodsin'?'selected="selected"':''}} value="/goodsin">All Jobs</option>
                            <option {{$status=='archiveJobs'?'selected="selected"':''}} value="/archiveJobs">Archived Jobs</option>
                            <option {{$status=='activeJobs'?'selected="selected"':''}} value="/activeJobs">Activated Jobs</option>
                ...
                <div class="col-md-2">
                    <a href="/goodsin/create" class="btn btn-primary btn-flat">Add New Job </a>
                </div>
                 @if(isset($search)) 
                  <div class="col-md-2">
                    <a href="/goodsin" class="btn btn-info btn-flat">Show All Jobs</a>
                </div>
                 @endif
            </div>
        </div>    
        ...
        <table class="table table-hover table-bordered pull-left table-striped table-condensed admin-user-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td  data-title="Job Number"> {{$c->goodsin_id}} </td>
                    ...
                    <td  data-title="Goods In Receipt">
                        <a class="btn btn-default btn-sm" href="/goodsin/invoiceJob/{{$c->goodsin_id}}" title="View">View
                        </a>
                    ...
                    <td class="{{$c->goodsin_status=='Active'?'success':'warning'}}" data-title="Status" >{{$c->goodsin_status}}</td>
