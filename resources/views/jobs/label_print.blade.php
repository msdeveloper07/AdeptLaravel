    ...
    @if($title=='Label Print')
         ...
         <tr>
            ...
            <tr>
                ...
                <td colspan="4"><h1>{{$job->clientId->client_title}}</h1></div></td>
            </tr>
            <tr>
                
                <td  colspan="1" style="font-size: 10px;">PROJECT NAME:</td>
                <td colspan="3"><span style="text-align:left; font-size: 40px;">{{$job->project_name}}</span></td>
            </tr>
            ...
            <tr>
              ...
              <tr>
                  ...
                  <td colspan="1"><h2>{{$l->job_id}}</h2></td>
      ...
      @else
            ...
            <tr>
              ...
              <tr>
                  ...
                  <td colspan="1" style="font-size: 10px;">ADEPT ESD JOB NO.</td>
                  <td colspan="1"><h2>{{$all_lots->job_id}}</h2></td>
