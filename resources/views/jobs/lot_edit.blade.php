    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li><a href="/jobs/{{$lot->job_id}}/">General</a></li>
                <li><a href="/jobs/{{$lot->job_id}}/edit">Edit Job</a></li>
                <li  class="active"><a href="/jobs/editLot/{{$id}}">Manage Lots</a></li>
...
<div class="row">
    <div class="col-md-6">
        <form  role="form" action='updateLot/{{$id}}' name='user_form' id='user_form' method="post">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <!--<a class="btn btn-primary pull-right" href="/jobs/labelPrint/{{$id}}">Print Label</a>-->
                    <div class="pull-right">

                        <a class="btn btn-primary" href="/jobs/createLot/{{$lot->job_id}}/">Create Lot</a>
                    </div> 
                    </div><!-- /.box-header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  id="job_id" name="job_id" class="form-control" value="{{$lot->job_id}}" readonly>
