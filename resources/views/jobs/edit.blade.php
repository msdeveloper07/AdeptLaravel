...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <li><a href="/jobs/{{$id}}/">General</a></li>
               <li  class="active"><a href="/jobs/{{$id}}/edit">Edit Job</a></li>
...
<div class="row">
      <div class="col-md-6">
    <form  role="form" action="/jobs/{{$id}}" name='user_form' id='user_form' method="post">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="job_number" name="job_number" class="form-control " value="{{$job->id}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Project Name" id="project_name" name="project_name" class="form-control "  value="{{$job->project_name}}">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <select name="client_name" id="client_id" class="form-control ">
                                ...
                                <option  {{$u->id==$job->client_id?'selected="selected"':''}} value="{{$u->id}}">{{$u->client_name}} </option>
                                @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Order Number" id="client_order_number" name="client_order_number" class="form-control "  value="{{$job->client_order_number}}">
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option {{$job->job_type==$c?'selected="selected"':''}} value='{{$c}}'>{{$c}}</option>
                                @endforeach                             
                                </select>    
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <label for="InputTitle">Supplier Name</label>
                                 <select name="supplier_id" id="supplier_id" class="form-control ">
                                   ...
                                   <option  {{$job->supplier_id==$s->id?'selected="selected"':''}} value='{{$s->id}}'>{{$s->supplier_name}}</option>
                                @endforeach                             
                                </select>   
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Haulage Company Name" id="haulage_company_name" name="haulage_company_name" class="form-control "  value="{{$job->haulage_company_name}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Goods In Date" id="goods_in_date" name="goods_in_date" class="form-control "  value="{{\App\Libraries\ZnUtilities::format_date($job->goods_in_date,10)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Total Volume" id="total_volume" name="total_volume" class="form-control " value="{{$job->total_volume}}" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Handling Charges" id="handling_charge" name="handling_charge" class="form-control "  value="{{$job->handling_charge}}">
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-gbp"></i></span>
                                <input type="text" placeholder="Enter Charges" id="charge_rate" name="charge_rate" class="form-control "  value="{{$job->charge_rate}}">
                            </div>
                        </div>
                        </div>
