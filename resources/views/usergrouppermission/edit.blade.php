                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user_group_id"   id="user_group_id">
                                ...
                                <option {{$u->id==$id?'selected="selected"':''}} value="{{$u->id}}">{{$u->user_group_name}} </option>
                            @endforeach
      ...
      @foreach($permission as $c)
       <tr>
           <td  data-title="Select">
               <input type="checkbox" class="check" name="cid[]" {{in_array($c->id, $ugpermission)?'checked="checked"':''}} value="{{$c->id}}" id="cid{{$c->id}}" />
           </td>
